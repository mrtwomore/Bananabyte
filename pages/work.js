...
export default function Work() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "Comprehensive workflow automation solution for a professional services firm using Make.com and AI integration, reducing manual processes by 85% and cutting operational costs by 40% while improving client service delivery and team productivity.",
      category: "ai",
      technologies: ["Make.com", "AI Integration", "Process Automation", "Custom Workflows", "API Integration"],
      image: "/images/ai-business-transformation.jpg",
      demoLink: "https://ai-demo.bananabyte.co.nz",
      fullDescription: "This project transformed operations for a professional services firm struggling with inefficient manual processes and increasing competitive pressure. The client needed a strategic technology partner to guide them through a complete workflow modernization while minimizing disruption to their client services.\n\nLeveraging Make.com's powerful automation platform, we designed and implemented a comprehensive solution that seamlessly integrated with their existing systems while introducing advanced AI capabilities to handle complex decision-making processes.\n\nOur approach began with a thorough assessment of their existing workflows, identifying critical bottlenecks and opportunities for automation. We developed a phased implementation strategy that prioritized quick wins while building toward a completely transformed operational ecosystem.\n\nKey components of the transformation included:\n\n• Automated document processing and data extraction that reduced manual data entry by 85%\n• Intelligent client intake system with automated information gathering and verification\n• Custom notification workflows ensuring timely follow-ups and eliminating dropped tasks\n• Integration with existing CRM and accounting systems for seamless data flow\n• Custom dashboards providing real-time visibility into business operations\n\nThe implementation included comprehensive staff training and change management support to ensure successful adoption. We developed custom documentation and conducted hands-on workshops to build internal capability and confidence with the new systems.\n\nThe results exceeded expectations, with the client reporting a 40% reduction in operational costs, 65% faster client onboarding, and significantly improved staff satisfaction. Team members previously bogged down with repetitive tasks were able to refocus on high-value client work, improving both service quality and job satisfaction.\n\nThe modular design of the Make.com implementation allows the client to easily expand and modify workflows as their business evolves, ensuring the solution continues to deliver value well into the future."
    }
  ];
